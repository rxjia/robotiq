...
class RobotiqGripperURCapBridge:
    """
    ...
    def connect(self, hostname, port = 63352, socket_timeout = 2.0, gripper_sid=9):
        ...
        print("Connected to gripper with ack: " + str(is_ack))
    ...
    def rq_reset_and_wait(self):
        ...
        while(self._get_var(self.ACT) != 0):
            time.sleep(0.1)
...
if __name__ == '__main__':
    # gripper = Gripper2f85()
    gripper = RobotiqGripperURCapBridge('10.2.0.50')
